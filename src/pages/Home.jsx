...
const Home = () => {
  return (
    <div className=" bg-[#3B9239] font-flyingBird">
      <Nav />
...
<div id="home" className="w-full flex flex-col justify-center items-center py-[40px] md:py-[100px] bg-bg1 bg-center bg-cover bg-no-repeat mt-[0px] md:mt-[-100px]">
  <div className="flex flex-col justify-center items-center">
    ...
    <a href="https://x.com/smidgeerc" target="_blank" rel="noopener noreferrer">
        <li>
          <img src={item1} alt="link1" className="w-[20px] sm:w-[30px] md:w-[50px] lg:w-[70px]" />
        </li>
      </a>
            <a href="https://t.me/Smidgeerc" target="_blank" rel="noopener noreferrer">
        <li>
          <img src={item2} alt="link2" className="w-[20px] sm:w-[30px] md:w-[50px] lg:w-[70px]" />
        </li>
      </a>
  ...
  <div className="flex justify-center items-center mt-[-50px] sm:mt-[-80px] md:mt-[-130px] lg:mt-[-150px] xl:mt-[-200px] ">
    <img src={bgsmiley} alt="bgsmiley" className="w-[40%] sm:w-[50%] md:w-[70%] lg:w-[80%]" />
  </div>
</div>
