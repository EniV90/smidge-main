...
const Home = () => {
  return (
    <div className=" bg-[#3B9239] font-flyingBird">
      ...
      <div
        id="uniswap"
        className="flex flex-col justify-center items-center w-full py-[50px] md:py-[100px] mt-4 bg-bg2 bg-center bg-cover bg-no-repeat "
      >
        ...
        <div className="lg:w-[50%] w-[90%] mt-16 relative">
          ...
          <div >
            <Widget />
            {/* <button className="w-full rounded-2xl px-4 py-4 text-[#ab52ad] text-2xl font-bold bg-[#281A28]">
              Connect Wallet
            </button> */}
          </div>
        </div>
